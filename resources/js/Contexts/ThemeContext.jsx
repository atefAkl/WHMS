...
export function ThemeProvider({ children }) {
    const [theme, setTheme] = useState(
        () => localStorage.getItem("wms_theme") || "blue",
    );
    const [bg, setBg] = useState(
        () => localStorage.getItem("wms_bg") || "flat-light",
    );
    const [font, setFont] = useState(
        () => localStorage.getItem("wms_font") || "noto",
    );
    const [verticalSpacing, setVerticalSpacing] = useState(
        () => localStorage.getItem("wms_vertical_spacing") || "normal",
    );
    ...
    useEffect(() => {
        ...
        // Apply main vertical spacing between top-level page sections
        const spacingValue =
            verticalSpacings[verticalSpacing] || verticalSpacings.normal;
        root.style.setProperty("--layout-main-gap-y", spacingValue);
        localStorage.setItem("wms_vertical_spacing", verticalSpacing);
    }, [theme, bg, font, verticalSpacing]);
