...
export default function Index({ seasons, openCreate = false }) {
    ...
    return (
        <AuthenticatedLayout header={breadcrumbs}>
            ...
            <div className="max-w-5xl mx-auto pb-8 main-stack-y">
                <div className="flex items-center justify-between">
                    <div>
                        ...
                        <p className="text-sm text-text-muted mt-1">
                            {lang === "ar"
                                ? "إدارة فترات ومواسم العمل في النظام"
                                : "Manage work periods and seasons in the system"}
                        </p>
                    </div>
                                ...
                                {seasons.length === 0 ? (
                                    ...
                                    seasons.map((season) => (
                                        ...
                                        >
                                            ...
                                            <td
                                                className="px-4 py-3 font-mono text-text-muted"
                                                dir="ltr"
                                            >
                                                {season.start_date}
                                            </td>
                                            ...
                                            <td className="px-4 py-3 text-center">
                                                <span
                                                    className={`text-[10px] px-2 py-0.5 rounded-full font-medium ${season.is_active ? "bg-emerald-500/10 text-emerald-600" : "bg-gray-500/10 text-gray-500"}`}
                                                >
                                                    {season.is_active
                                                        ? lang === "ar"
                                                            ? "نشط"
                    ...
                    <div className="grid grid-cols-1 gap-4">
                        <div>
                            <InputLabel
                                value={
                                    lang === "ar"
                                        ? "كود الموسم (مثل DTS26) *"
                                        : "Season Code (e.g. DTS26) *"
                                }
                            />
                            <TextInput
