...
export default function Countries({ auth, countries, filters }) {
    ...
    const seedCountries = () => {
        if (
            confirm(
                lang === "ar"
                    ? "سيتم إضافة جميع دول العالم تلقائياً، هل تريد الاستمرار؟"
                    : "All countries will be added automatically, continue?",
            )
        ) {
                    ...
                    <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between mb-6">
                        <div>
                            ...
                            <p className="text-sm text-text-muted mt-1">
                                {lang === "ar"
                                    ? "إدارة قائمة الدول ومفاتيح الاتصال"
                                    : "Manage countries and calling codes list"}
                            </p>
                        </div>
                        <div className="flex items-center gap-3">
                            {countries.total < 50 && (
                                <button
                                    ...
                                    className="flex items-center justify-center gap-2 rounded-lg border border-primary text-primary bg-surface px-4 py-2 text-sm font-medium hover:bg-primary/5 transition-colors shadow-sm"
                                >
                                        ...
                                        <tbody className="divide-y divide-border bg-surface">
                                            {countries.data.map((country) => (
                                                ...
                                                >
                                                    ...
                                                    <td
                                                        className="whitespace-nowrap px-6 py-4 text-sm text-text font-medium"
                                                        dir="ltr"
                                                    >
                                                        {country.phone_code ||
                                                            "-"}
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <TextInput
                                    id="code"
                                    type="text"
                                    className="mt-1 block w-full text-left uppercase"
                                    value={data.code}
                                    onChange={(e) =>
                                        setData(
                                            "code",
